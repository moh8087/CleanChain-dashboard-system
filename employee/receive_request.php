...
// Display teacher menu:
	...
	if ( (isset($_GET['id'])) && (is_numeric($_GET['id'])) ) { // From teacher.php
		...
		$r = mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc));
			...
			echo '<form action="receive_request.php" method="post">';

			echo '<div class="panel panel-success">
      <div class="panel-heading"> Are you sure to receive this order?</div>
	...
	<br>
    <button type="submit" class="btn btn-success btn-lg" name="submit">Receive</button>
...
';
	...
	if ($trimmed['active'] == 1) { // If the choice is OK for delete test...
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
			     ...
			     echo '<div class="alert alert-success">Order successfully Recicved</div>';
