...
echo '</h1>';
	...
	$q = "SELECT id, email, rid, rname, rmobile,pickaddress, picklatitude, picklongitude, did, dname, dmobile, totalcharge, status, created_at FROM requests WHERE did='".$u."' ORDER BY id DESC LIMIT 10";
