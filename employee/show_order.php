...
// Display teacher menu:
	...
	$r = mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc));
		...
		if (mysqli_num_rows($r) > 0)
		{
            ...
            <td><a href="receive_request.php?id=' .  $row['id'] . '">Accept Order  <img src="images/accept.png" alt="" /></a></td>
            <td><a href="cancel_request.php?id=' .  $row['id'] . '">Cancel Order  <img src="images/cancel.png" alt="" /></a></td>
