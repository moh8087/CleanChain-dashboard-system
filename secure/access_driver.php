...
class access {
    ...
    public function registerDriver($email, $password, $salt, $mobile, $fullname, $emailConfirmed) {

        // sql command
        $sql = "INSERT INTO drivers SET demail=?, dmobile=?, password=?, salt=?, dfullname=?, emailConfirmed=?";
        ...
        $statement->bind_param("sssssi", $email, $mobile, $password, $salt, $fullname, $emailConfirmed);
    ...
    public function updateAccountDriver($email, $mobile, $fullname, $carmodel, $id) {

      $sql = "UPDATE drivers SET demail=?, dmobile=?, dfullname=?, carmodel=? WHERE did=?";
      $statement = $this->conn->prepare($sql);
      ...
      $statement->bind_param("ssssi", $email, $mobile, $fullname, $carmodel, $id);
    ...
    public function updateDriver($status, $dlat, $dlog, $did) {

      $sql = "UPDATE drivers SET status=?, dlat=?, dlog=? WHERE did=?";
      $statement = $this->conn->prepare($sql);
      ...
      $statement->bind_param("sssi", $status, $dlat, $dlog, $did);
    ...
    // Update picklatitude and picklongitude in End Trip
    public function addDropAddress( $droplatitude, $droplongitude, $id) {

      // sql statement
      $sql = "UPDATE requests SET droplatitude=?, droplongitude=? WHERE id=?";
      ...
      $statement->bind_param("ssi", $droplatitude, $droplongitude , $id);
    ...
    public function getTripDropAddress($id) {

        // declare array to store all information we got
        $returnArray = array();

        // sql statement
        $sql = "SELECT id, droplatitude, droplongitude FROM requests WHERE id='".$id."'";
    ...
    // Select user information by email
    public function selectDriver($email) {

        $returArray = array();

        // sql command
        $sql = "SELECT * FROM drivers WHERE demail='".$email."'";
    ...
    // Select Driver information by did
    public function selectDriverDid($did) {
    ...
    public function getDriver($mobile) {
        ...
        // sql statement
        $sql = "SELECT * FROM drivers WHERE dmobile='".$mobile."'";
    ...
    //  Bring all request information by using request ID to show them to the rider
    public function tripInfoDriver($id) {

        // declare array to store all information we got
        $returnArray = array();

        // sql statement
        $sql = "SELECT id, email, rid, rname, rmobile, did, dname, dmobile, dphoto, carmodel, picklatitude, picklongitude,  dlat , dlog FROM requests WHERE id='".$id."'";
    ...
    // Get Rider's trips
    public function getMyTrips($did) {

        // declare array to store all information we got
        $returnArray = array();

        // sql statement
        $sql = "SELECT id, email, rid, rname, rmobile, pickaddress, picklatitude, picklongitude, dropaddress,notes ,totalcharge, status, created_at FROM requests WHERE did='".$did."' ORDER BY id DESC" ;
    ...
    public function getTripsNumber($did) {


        // sql statement
        $sql = "SELECT id ,totalcharge, status, created_at FROM requests WHERE did='".$did."' and status='completed'    " ;


        // assign result we got from $sql to $result var
        $result = $this->conn->query($sql);

        $tripsNumber = mysqli_num_rows($result) ;
    ...
    // Get number of cancelled trips
    public function getCancelledNumber($did) {


        // sql statement
        $sql = "SELECT id ,totalcharge, status, created_at FROM requests WHERE did='".$did."' and status='cancelled'    " ;
    ...
    public function getTotalSuccessfull($did) {


        // sql statement
        $sql = "SELECT id ,totalcharge, status, created_at FROM requests WHERE did='".$did."' " ;
    ...
    public function getTotalSuccessfullToday($did) {

        $today = date('yyyy-MM-dd HH:mm:ss');


        // sql statement
        $sql = "SELECT id ,totalcharge, status, created_at FROM requests WHERE did='".$did."' and created_at='".$today."' " ;
