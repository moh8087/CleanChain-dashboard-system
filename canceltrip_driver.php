...
$details = array();
$details["subject"] = "Order is Cancelled";
...
<p>Driver has been cancelled your order</p>
<p>Order number is: " . $result["id"] . "</p>
<p>Please order agian</p>
<p>See you soon!</p>
...
/*send SMS to Rider
$message = "Driver has CANCELLED your Order number: " . $result["id"] . "";
$message .= ", Please order again";
