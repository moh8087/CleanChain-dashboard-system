...
?>			
  ...
  <form action="adding_price.php" method="post" role="form">

  <div class="panel panel-default">
      <div class="panel-heading">Add total price:</div>
      <div class="panel-body">
	  <div class="form-group">
      <input type="text" name="price" class="form-control" id="text" placeholder="Adding price here " value="<?php if (isset($trimmed['price'])) echo $trimmed['price']; ?>">
    </div></div>
    </div>
...
<?php			
	...
	if ($price) { // If everything's OK...
			...
			$q = "UPDATE requests SET totalcharge='$price' , status='$completed' WHERE id='$id'";
			$r = mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc));
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK and the question is succssefully entered.
                ...
                Or <a href="adding_price.php?id=' .  $id . '">Modify price</a></div>';
				echo '<br> <br>';
