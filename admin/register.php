	...
	if ($fn && $e && $p && $phone) { // If everything's OK...
		...
		if (mysqli_num_rows($r) == 0) { // Available.
			...
			*/
			...
			$q = "INSERT INTO admins (email, pass, fullname, user_level, registration_date, phone) VALUES ('$e', SHA1('$p'), '$fn','4', NOW(), '$phone')";
			$r = mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc));

			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.

				// Send the email:
				$body = "Thank you for registering in ........ ";
				mail($trimmed['email'], 'Registration Confirmation', $body, 'From: moh8087@hotmail.com');
...
<a href="login.php" title="Login"> Do you have an account? Login </a><br /></center>
