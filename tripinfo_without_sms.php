...
$details["body"] .= "</body></html>";
  ...
  */
  ...
  //$message2 .= " Location: http://www.google.com/maps/place/". $request["picklatitude"] .",". $request["picklongitude"] ."";
  ...
  // send SMS to Rider
  $message = "Request number is: " . $result["id"] . "";
